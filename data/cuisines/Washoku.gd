...
static func get_dishes() -> Array:
	return [
		...
		},
		{
			...
			"on_activate": [],
			"description": "【文本已修复】炸出汁豆腐。"
		},
		{
			"id": "takoyaki", "name": "章鱼烧", "name_cn": "章鱼烧",
			"cuisine": "washoku", "tier": 1, "size": 1, "cooldown": 4.0,
			"flavor": 8, "mod_slots": 2,
			"tags": ["seafood", "fried", "light"],
			"triggers": [
