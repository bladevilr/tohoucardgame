...
static func get_dishes() -> Array:
	return [
		...
		},
		{
			...
			"on_activate": [],
			"description": "【文本已修复】鸡肉丸串。"
		},
		{
			"id": "sanma_shioyaki", "name": "盐烤秋刀鱼", "name_cn": "盐烤秋刀鱼",
			"cuisine": "yatai", "tier": 2, "size": 2, "cooldown": 6.5,
			"flavor": 13, "mod_slots": 2,
			"tags": ["seafood", "grilled", "light"],
			"triggers": [
