...
func _init_techniques():
	...
	_add("wok_hei", "镬气", "chinese",
		...
		["stir_fried"], [],
		"传说中只有驾驭过太阳之火的灵乌路空才能催出的极致镬气。铁锅与烈焰共鸣的刹那，食材表面焦香封锁，内里鲜嫩欲滴，连地灵殿的主人都为之倾倒。")
	...
	_add("knife_art", "极刀工", "japanese",
		{technique=0.35, presentation=0.10}, 0.0,
		["raw"], ["seafood","meat"],
		"射命丸文曾在《文文新闻》头版刊载的绝技——刀光快过天狗之风，食材在眨眼间被分解为精密的艺术品。唯有最上等的海鲜与肉类方配得上这般刀工。")

	# ===== Wild =====
	_add("charcoal_grill", "炭火直烤", "wild",
		{flavor=0.30, aroma=0.10, presentation=-0.15}, -1.0,
		[], ["meat"],
		"旧地狱的炭火带着地底千年的余温，将肉类烤出最原始的焦香。星熊勇仪常在地底都市的宴会上豪迈地翻烤整块兽肉，粗犷却令人欲罢不能。")
	_add("smoke", "烟熏", "wild",
