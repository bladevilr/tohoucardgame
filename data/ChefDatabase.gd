...
func _init_chefs() -> void:
	...
	_add(
		...
		3,
		{flavor = 4, aroma = 4, technique = 7, presentation = 6}
	)
	...
	_add(
		...
		3,
		{flavor = 5, aroma = 4, technique = 8, presentation = 3}
	)
	...
	_add(
		...
		"气功调味",
		"passive",
		{char_aroma_effect_mult = 1.30, char_aroma_bonus_mult = 1.30},
		"红魔馆门番的气功融入料理之中。焦香在她手中化为龙之吐息，焦香相关收益提升30%。",
		3,
		{flavor = 8, aroma = 6, technique = 4, presentation = 3}
	)
	...
	_add(
		...
		3,
		{flavor = 5, aroma = 6, technique = 5, presentation = 4}
	)
	...
	_add(
		...
		"人偶使的精密操控让每一道菜都如艺术品般完美。摆盘收益提升30%，额外的人偶手臂让厨具栏位+1。",
		4,
		{flavor = 4, aroma = 3, technique = 6, presentation = 7}
	)
	...
	_add(
		...
		3,
		{flavor = 4, aroma = 4, technique = 6, presentation = 6}
	)
	...
	_add(
		...
		"月兔的狂气之瞳让对手陷入混乱。开局随机提高对手冷却，红色的眼眸施加味觉疲劳。",
		3,
		{flavor = 5, aroma = 5, technique = 5, presentation = 5}
	)
