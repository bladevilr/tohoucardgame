...
const TERM_DEFINITIONS := {
	...
	"开胃": "引擎机制。辣/酸标签菜激活时，减少相邻菜品CD 0.3秒，形成连锁加速。",
	"上瘾": "引擎机制。浓郁/鲜味标签菜激活时叠加上瘾层数，每层每秒自动产出1分。最多50层。",
	"爆香": "引擎机制。烤/炒标签菜激活时积累热量，满5次后爆发，爆发分数 = 积累次数 × 8。",
	"爽脆": "引擎机制。油炸标签菜激活时有20%概率双重激活，额外触发一次完整效果。",
	"清口": "引擎机制。清淡/茶标签菜激活时清除2层油腻，每清1层全场CD加速0.5秒。",
	"油腻（机制）": "引擎机制。同时拥有浓郁+油炸标签的菜激活时叠加油腻，每层减慢全场CD 10%。",
	"提鲜": "引擎机制。鲜味标签菜在同菜系≥3道时，标记该槽位下次激活分数翻倍。",
	"发酵": "引擎机制。发酵标签菜首次激活时额外+50%分数，鼓励多样化配置。",
}
